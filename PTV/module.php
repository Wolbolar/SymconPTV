...
class PTV extends IPSModule
{
	...
	public function ApplyChanges()
	{
		...
		$PanasonicTV_playback_ass = Array(
		...
		$PanasonicTV_menu_ass = Array(
			Array(0, $this->Translate("Home"), "", -1),
			Array(1, $this->Translate("Info"), "", -1)
		);
